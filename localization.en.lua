...
SMARTBUFF_WHATSNEW = "\n\n|cffffffff         Whats new:|r\n\n"
  ...
  .."\n\n"
  .."          Changes in r37.010226:\n\n"
  .."             * Fixed buff order reset bug - custom order now persists.\n"
  .."             * Fix most or all of the secret values in-combat lua restrictions\n"
  .."             * Fixed toys appearing (or not appearing) when \"Include Toys\" is disabled.\n"
  .."             * Buff order now preserved when opening/closing options.\n"
  .."             * Improved buff detection accuracy with better API handling.\n"
  .."             * Restored missing buffs (Demonic Healthstone, Water elemental).\n"
  .."             * Profile resets no longer required for most updates. (fingers crossed)\n"
