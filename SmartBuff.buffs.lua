...
function SMARTBUFF_InitSpellIDs()
  SMARTBUFF_TESTSPELL       = C_Spell.GetSpellInfo(774);

  -- Druid
  SMARTBUFF_DRUID_CAT       = C_Spell.GetSpellInfo(768);   --"Cat Form"
  SMARTBUFF_DRUID_TREE      = C_Spell.GetSpellInfo(33891); --"Incarnation: Tree of Life"
  SMARTBUFF_DRUID_TREANT    = C_Spell.GetSpellInfo(114282);--"Treant Form"
  SMARTBUFF_DRUID_MOONKIN   = C_Spell.GetSpellInfo(24858); --"Moonkin Form"
  --SMARTBUFF_DRUID_MKAURA    = C_Spell.GetSpellInfo(24907); --"Moonkin Aura"
  SMARTBUFF_DRUID_TRACK     = C_Spell.GetSpellInfo(5225);  --"Track Humanoids"
  SMARTBUFF_MOTW            = C_Spell.GetSpellInfo(1126);  --"Mark of the Wild"
  SMARTBUFF_BARKSKIN        = C_Spell.GetSpellInfo(22812); --"Barkskin"
  SMARTBUFF_TIGERSFURY      = C_Spell.GetSpellInfo(5217);  --"Tiger's Fury"
  SMARTBUFF_SAVAGEROAR      = C_Spell.GetSpellInfo(52610); --"Savage Roar"
  SMARTBUFF_CENARIONWARD    = C_Spell.GetSpellInfo(102351);--"Cenarion Ward"
  SMARTBUFF_DRUID_BEAR      = C_Spell.GetSpellInfo(5487);  --"Bear Form"

  -- Priest
  SMARTBUFF_PWF             = C_Spell.GetSpellInfo(21562); --"Power Word: Fortitude"
  SMARTBUFF_PWS             = C_Spell.GetSpellInfo(17);    --"Power Word: Shield"
  --SMARTBUFF_FEARWARD        = C_Spell.GetSpellInfo(6346);  --"Fear Ward"
  SMARTBUFF_RENEW           = C_Spell.GetSpellInfo(139);   --"Renew"
  SMARTBUFF_LEVITATE        = C_Spell.GetSpellInfo(1706);  --"Levitate"
  SMARTBUFF_SHADOWFORM      = C_Spell.GetSpellInfo(232698); --"Shadowform"
  SMARTBUFF_VAMPIRICEMBRACE = C_Spell.GetSpellInfo(15286); --"Vampiric Embrace"
  --SMARTBUFF_LIGHTWELL       = C_Spell.GetSpellInfo(724);   --"Lightwell"
  --SMARTBUFF_CHAKRA1         = C_Spell.GetSpellInfo(81206)  --"Chakra Sanctuary"
  --SMARTBUFF_CHAKRA2         = C_Spell.GetSpellInfo(81208)  --"Chakra Serenity"
  --SMARTBUFF_CHAKRA3         = C_Spell.GetSpellInfo(81209)  --"Chakra Chastise"
  -- Priest buff links
  S.LinkPriestChakra        = { SMARTBUFF_CHAKRA1, SMARTBUFF_CHAKRA2, SMARTBUFF_CHAKRA3 };

  -- Mage
  SMARTBUFF_AB              = C_Spell.GetSpellInfo(1459);  --"Arcane Intellect"
  SMARTBUFF_DALARANB        = C_Spell.GetSpellInfo(61316); --"Dalaran Brilliance"
  SMARTBUFF_FROSTARMOR      = C_Spell.GetSpellInfo(7302);  --"Frost Armor"
  SMARTBUFF_MAGEARMOR       = C_Spell.GetSpellInfo(6117);  --"Mage Armor"
  --SMARTBUFF_MOLTENARMOR     = C_Spell.GetSpellInfo(30482); --"Molten Armor"
  SMARTBUFF_MANASHIELD      = C_Spell.GetSpellInfo(35064); --"Mana Shield"
  --SMARTBUFF_ICEWARD         = C_Spell.GetSpellInfo(111264);--"Ice Ward"
  SMARTBUFF_ICEBARRIER      = C_Spell.GetSpellInfo(11426); --"Ice Barrier"
  --SMARTBUFF_COMBUSTION      = C_Spell.GetSpellInfo(11129); --"Combustion"
  SMARTBUFF_ARCANEPOWER     = C_Spell.GetSpellInfo(12042); --"Arcane Power"
  SMARTBUFF_PRESENCEOFMIND  = C_Spell.GetSpellInfo(205025); --"Presence of Mind"
  SMARTBUFF_ICYVEINS        = C_Spell.GetSpellInfo(12472); --"Icy Veins"
  SMARTBUFF_SUMMONWATERELE  = C_Spell.GetSpellInfo(31687); --"Summon Water Elemental"
  SMARTBUFF_SLOWFALL        = C_Spell.GetSpellInfo(130);   --"Slow Fall"
  SMARTBUFF_REFRESHMENT     = C_Spell.GetSpellInfo(42955); --"Conjure Refreshment"
  SMARTBUFF_TEMPSHIELD      = C_Spell.GetSpellInfo(198111);--"Temporal Shield"
  --SMARTBUFF_AMPMAGIC        = C_Spell.GetSpellInfo(159916);--"Amplify Magic"

  SMARTBUFF_PRISBARRIER     = C_Spell.GetSpellInfo(235450);--"Prismatic Barrier"
  SMARTBUFF_IMPPRISBARRIER     = C_Spell.GetSpellInfo(321745);--"Improved Prismatic Barrier"

  SMARTBUFF_BLAZBARRIER     = C_Spell.GetSpellInfo(235313);--"Blazing Barrier"
  SMARTBUFF_ARCANEFAMILIAR  = C_Spell.GetSpellInfo(205022);--"Arcane Familiar"
  SMARTBUFF_CREATEMG		= C_Spell.GetSpellInfo(759);   --"Conjure Mana Gem"

  -- Mage buff links
  S.ChainMageArmor = { SMARTBUFF_FROSTARMOR, SMARTBUFF_MAGEARMOR, SMARTBUFF_MOLTENARMOR };

  -- Warlock
  SMARTBUFF_AMPLIFYCURSE    = C_Spell.GetSpellInfo(328774);--"Amplify Curse"
  SMARTBUFF_DEMONARMOR      = C_Spell.GetSpellInfo(285933);--"Demon ARmor"
  SMARTBUFF_DARKINTENT      = C_Spell.GetSpellInfo(183582);--"Dark Intent"
  SMARTBUFF_UNENDINGBREATH  = C_Spell.GetSpellInfo(5697);  --"Unending Breath"
  SMARTBUFF_SOULLINK        = C_Spell.GetSpellInfo(108447);--"Soul Link"
  SMARTBUFF_LIFETAP         = C_Spell.GetSpellInfo(1454);  --"Life Tap"
  SMARTBUFF_CREATEHS        = C_Spell.GetSpellInfo(6201);  --"Create Healthstone"
  SMARTBUFF_SOULSTONE       = C_Spell.GetSpellInfo(20707); --"Soulstone"
  SMARTBUFF_GOSACRIFICE     = C_Spell.GetSpellInfo(108503);--"Grimoire of Sacrifice"
  SMARTBUFF_INQUISITORGAZE  = C_Spell.GetSpellInfo(386344);--"Inquisitor's Gaze"

  -- Warlock pets
  SMARTBUFF_SUMMONIMP		= C_Spell.GetSpellInfo(688);    --"Summon Imp"
  SMARTBUFF_SUMMONFELHUNTER	= C_Spell.GetSpellInfo(691);    --"Summon Fellhunter"
  SMARTBUFF_SUMMONVOIDWALKER= C_Spell.GetSpellInfo(697);    --"Summon Voidwalker"
  SMARTBUFF_SUMMONSUCCUBUS	= C_Spell.GetSpellInfo(712);    --"Summon Succubus"
  SMARTBUFF_SUMMONINFERNAL	= C_Spell.GetSpellInfo(1122);   --"Summon Infernal"
  SMARTBUFF_SUMMONDOOMGUARD	= C_Spell.GetSpellInfo(18540);  --"Summon Doomguard"
  SMARTBUFF_SUMMONFELGUARD  = C_Spell.GetSpellInfo(30146);  --"Summon Felguard"
  SMARTBUFF_SUMMONFELIMP	= C_Spell.GetSpellInfo(112866); --"Summon Fel Imp"
  SMARTBUFF_SUMMONVOIDLORD	= C_Spell.GetSpellInfo(112867); --"Summon Voidlord"
  SMARTBUFF_SUMMONSHIVARRA	= C_Spell.GetSpellInfo(112868); --"Summon Shivarra"
  SMARTBUFF_SUMMONOBSERVER	= C_Spell.GetSpellInfo(112869); --"Summon Observer"
  SMARTBUFF_SUMMONWRATHGUARD= C_Spell.GetSpellInfo(112870); --"Summon Wrathguard"

  -- Hunter
  SMARTBUFF_TRUESHOTAURA    = C_Spell.GetSpellInfo(193526); --"Trueshot Aura" (P)
  SMARTBUFF_VOLLEY          = C_Spell.GetSpellInfo(194386); --"Volley"
  SMARTBUFF_RAPIDFIRE       = C_Spell.GetSpellInfo(3045);  --"Rapid Fire"
  SMARTBUFF_FOCUSFIRE       = C_Spell.GetSpellInfo(82692); --"Focus Fire"
  --SMARTBUFF_TRAPLAUNCHER    = C_Spell.GetSpellInfo(77769); --"Trap Launcher"
  --SMARTBUFF_CAMOFLAUGE      = C_Spell.GetSpellInfo(51753); --"Camoflauge"
  SMARTBUFF_AOTC            = C_Spell.GetSpellInfo(186257);  --"Aspect of the Cheetah"
  --SMARTBUFF_AOTP            = C_Spell.GetSpellInfo(13159); --"Aspect of the Pack"
  --SMARTBUFF_AOTF            = C_Spell.GetSpellInfo(172106); --"Aspect of the Fox"
  SMARTBUFF_AOTW			= C_Spell.GetSpellInfo(193530);	--"Aspect of the Wild"
  SMARTBUFF_AMMOI           = C_Spell.GetSpellInfo(162536); --"Incendiary Ammo"
  SMARTBUFF_AMMOP           = C_Spell.GetSpellInfo(162537); --"Poisoned Ammo"
  SMARTBUFF_AMMOF           = C_Spell.GetSpellInfo(162539); --"Frozen Ammo"
  --SMARTBUFF_LW1             = C_Spell.GetSpellInfo(160200); --"Lone Wolf: Ferocity of the Raptor"
  --SMARTBUFF_LW2             = C_Spell.GetSpellInfo(160203); --"Lone Wolf: Haste of the Hyena"
  --SMARTBUFF_LW3             = C_Spell.GetSpellInfo(160198); --"Lone Wolf: Grace of the Cat"
  --SMARTBUFF_LW4             = C_Spell.GetSpellInfo(160206); --"Lone Wolf: Power of the Primates"
  --SMARTBUFF_LW5             = C_Spell.GetSpellInfo(160199); --"Lone Wolf: Fortitude of the Bear"
  --SMARTBUFF_LW6             = C_Spell.GetSpellInfo(160205); --"Lone Wolf: Wisdom of the Serpent"
  --SMARTBUFF_LW7             = C_Spell.GetSpellInfo(172967); --"Lone Wolf: Versatility of the Ravager"
  --SMARTBUFF_LW8             = C_Spell.GetSpellInfo(172968); --"Lone Wolf: Quickness of the Dragonhawk"
  -- Hunter pets
  SMARTBUFF_CALL_PET_1      = C_Spell.GetSpellInfo(883  ); -- "Call Pet 1"
  SMARTBUFF_CALL_PET_2      = C_Spell.GetSpellInfo(83242); -- "Call Pet 2"
  SMARTBUFF_CALL_PET_3      = C_Spell.GetSpellInfo(83243); -- "Call Pet 3"
  SMARTBUFF_CALL_PET_4      = C_Spell.GetSpellInfo(83244); -- "Call Pet 4"
  SMARTBUFF_CALL_PET_5      = C_Spell.GetSpellInfo(83245); -- "Call Pet 5"
  -- Hunter buff links
  ...
  -- Shaman
  SMARTBUFF_LIGHTNINGSHIELD = C_Spell.GetSpellInfo(192106); --"Lightning Shield"
  SMARTBUFF_WATERSHIELD     = C_Spell.GetSpellInfo(52127);  --"Water Shield"
  SMARTBUFF_EARTHSHIELD     = C_Spell.GetSpellInfo(974);    --"Earth Shield"
  SMARTBUFF_WATERWALKING    = C_Spell.GetSpellInfo(546);    --"Water Walking"
  SMARTBUFF_EMASTERY        = C_Spell.GetSpellInfo(16166);  --"Elemental Mastery"
  SMARTBUFF_ASCENDANCE_ELE  = C_Spell.GetSpellInfo(114050); --"Ascendance (Elemental)"
  SMARTBUFF_ASCENDANCE_ENH  = C_Spell.GetSpellInfo(114051); --"Ascendance (Enhancement)"
  SMARTBUFF_ASCENDANCE_RES  = C_Spell.GetSpellInfo(114052); --"Ascendance (Restoration)"
  SMARTBUFF_WINDFURYW       = C_Spell.GetSpellInfo(33757);  --"Windfury Weapon"
  SMARTBUFF_FLAMETONGUEW    = C_Spell.GetSpellInfo(318038); --"Flametongue Weapon"
  SMARTBUFF_EVERLIVINGW     = C_Spell.GetSpellInfo(382021); --"Everliving Weapon"

  -- Shaman buff links
  S.ChainShamanShield = { SMARTBUFF_LIGHTNINGSHIELD, SMARTBUFF_WATERSHIELD, SMARTBUFF_EARTHSHIELD };

  -- Warrior
  SMARTBUFF_BATTLESHOUT     = C_Spell.GetSpellInfo(6673);   --"Battle Shout"
  --SMARTBUFF_COMMANDINGSHOUT = C_Spell.GetSpellInfo(97462);    --"Reallying Cry"
  SMARTBUFF_BERSERKERRAGE   = C_Spell.GetSpellInfo(18499);  --"Berserker Rage"
  SMARTBUFF_BATSTANCE       = C_Spell.GetSpellInfo(386164); --"Battle Stance"
  SMARTBUFF_DEFSTANCE       = C_Spell.GetSpellInfo(197690); --"Defensive Stance"
  SMARTBUFF_GLADSTANCE      = C_Spell.GetSpellInfo(156291); --"Gladiator Stance"
  SMARTBUFF_SHIELDBLOCK     = C_Spell.GetSpellInfo(2565);   --"Shield Block"
  ...
  -- Rogue
  SMARTBUFF_STEALTH         = C_Spell.GetSpellInfo(1784);  --"Stealth"
  SMARTBUFF_BLADEFLURRY     = C_Spell.GetSpellInfo(13877); --"Blade Flurry"
  SMARTBUFF_SAD             = C_Spell.GetSpellInfo(5171);  --"Slice and Dice"
  SMARTBUFF_EVASION         = C_Spell.GetSpellInfo(5277);  --"Evasion"
  SMARTBUFF_HUNGERFORBLOOD  = C_Spell.GetSpellInfo(60177); --"Hunger For Blood"
  SMARTBUFF_TRICKS          = C_Spell.GetSpellInfo(57934); --"Tricks of the Trade"
  SMARTBUFF_RECUPERATE      = C_Spell.GetSpellInfo(185311); --"Crimson Vial
  -- Poisons
  SMARTBUFF_WOUNDPOISON         = C_Spell.GetSpellInfo(8679);   --"Wound Poison"
  SMARTBUFF_CRIPPLINGPOISON     = C_Spell.GetSpellInfo(3408);   --"Crippling Poison"
  SMARTBUFF_DEADLYPOISON        = C_Spell.GetSpellInfo(2823);   --"Deadly Poison"
  SMARTBUFF_LEECHINGPOISON      = C_Spell.GetSpellInfo(108211); --"Leeching Poison"
  SMARTBUFF_INSTANTPOISON       = C_Spell.GetSpellInfo(315584); --"Instant Poison"
  SMARTBUFF_NUMBINGPOISON       = C_Spell.GetSpellInfo(5761);   --"Numbing Poison"
  SMARTBUFF_AMPLIFYPOISON       = C_Spell.GetSpellInfo(381664); --"Amplifying Poison"
  SMARTBUFF_ATROPHICPOISON      = C_Spell.GetSpellInfo(381637);   --"Atrophic Poison"
  ...
  -- Paladin
  SMARTBUFF_RIGHTEOUSFURY         = C_Spell.GetSpellInfo(25780);  --"Righteous Fury"
--  SMARTBUFF_HOLYSHIELD            = C_Spell.GetSpellInfo(20925);  --"Sacred Shield"
  SMARTBUFF_BOK                   = C_Spell.GetSpellInfo(203538); --"Greater Blessing of Kings"
--  SMARTBUFF_BOM                   = C_Spell.GetSpellInfo(203528); --"Greater Blessing of Might"
  SMARTBUFF_BOW                   = C_Spell.GetSpellInfo(203539); --"Greater Blessing of Wisdom"
  SMARTBUFF_HOF                   = C_Spell.GetSpellInfo(1044);   --"Blessing of Freedom"
  SMARTBUFF_HOP                   = C_Spell.GetSpellInfo(1022);   --"Blessing of Protection"
  SMARTBUFF_HOSAL                 = C_Spell.GetSpellInfo(204013); --"Blessing of Salvation"
--  SMARTBUFF_SOJUSTICE             = C_Spell.GetSpellInfo(20164);  --"Seal of Justice"
--  SMARTBUFF_SOINSIGHT             = C_Spell.GetSpellInfo(20165);  --"Seal of Insight"
--  SMARTBUFF_SORIGHTEOUSNESS       = C_Spell.GetSpellInfo(20154);  --"Seal of Righteousness"
--  SMARTBUFF_SOTRUTH               = C_Spell.GetSpellInfo(31801);  --"Seal of Truth"
--  SMARTBUFF_SOCOMMAND             = C_Spell.GetSpellInfo(105361); --"Seal of Command"
  SMARTBUFF_AVENGINGWARTH         = C_Spell.GetSpellInfo(31884);  --"Avenging Wrath"
  SMARTBUFF_BEACONOFLIGHT         = C_Spell.GetSpellInfo(53563);  --"Beacon of Light"
  SMARTBUFF_BEACONOFAITH          = C_Spell.GetSpellInfo(156910); --"Beacon of Faith"
  SMARTBUFF_CRUSADERAURA          = C_Spell.GetSpellInfo(32223); --"Crusader Aura"
  SMARTBUFF_DEVOTIONAURA          = C_Spell.GetSpellInfo(465); --"Devotion Aura"
  SMARTBUFF_RETRIBUTIONAURA       = C_Spell.GetSpellInfo(183435); --"Retribution Aura"
  -- Paladin buff links
  ...
  -- Death Knight
  SMARTBUFF_DANCINGRW         = C_Spell.GetSpellInfo(49028); --"Dancing Rune Weapon"
--  SMARTBUFF_BLOODPRESENCE     = C_Spell.GetSpellInfo(48263); --"Blood Presence"
--  SMARTBUFF_FROSTPRESENCE     = C_Spell.GetSpellInfo(48266); --"Frost Presence"
--  SMARTBUFF_UNHOLYPRESENCE    = C_Spell.GetSpellInfo(48265); --"Unholy Presence"
  SMARTBUFF_PATHOFFROST       = C_Spell.GetSpellInfo(3714);  --"Path of Frost"
--  SMARTBUFF_BONESHIELD        = C_Spell.GetSpellInfo(49222); --"Bone Shield"
  SMARTBUFF_HORNOFWINTER      = C_Spell.GetSpellInfo(57330); --"Horn of Winter"
  SMARTBUFF_RAISEDEAD         = C_Spell.GetSpellInfo(46584); --"Raise Dead"
--  SMARTBUFF_POTGRAVE          = C_Spell.GetSpellInfo(155522); --"Power of the Grave" (P)
  -- Death Knight buff links
  S.ChainDKPresence = { SMARTBUFF_BLOODPRESENCE, SMARTBUFF_FROSTPRESENCE, SMARTBUFF_UNHOLYPRESENCE };

  -- Monk
--  SMARTBUFF_LOTWT           = C_Spell.GetSpellInfo(116781); --"Legacy of the White Tiger"
--  SMARTBUFF_LOTE            = C_Spell.GetSpellInfo(115921); --"Legacy of the Emperor"
  SMARTBUFF_BLACKOX         = C_Spell.GetSpellInfo(115315); --"Summon Black Ox Statue"
  SMARTBUFF_JADESERPENT     = C_Spell.GetSpellInfo(115313); --"Summon Jade Serpent Statue"
  SMARTBUFF_SOTFIERCETIGER  = C_Spell.GetSpellInfo(103985); --"Stance of the Fierce Tiger"
  SMARTBUFF_SOTSTURDYOX     = C_Spell.GetSpellInfo(115069); --"Stagger"
--  SMARTBUFF_SOTWISESERPENT  = C_Spell.GetSpellInfo(115070); --"Stance of the Wise Serpent"
--  SMARTBUFF_SOTSPIRITEDCRANE= C_Spell.GetSpellInfo(154436); --"Stance of the Spirited Crane"
  ...
  -- Evoker
  SMARTBUFF_BRONZEBLESSING  = C_Spell.GetSpellInfo(364342);   --"Blessing of the Bronze"
  SMARTBUFF_Visage          = C_Spell.GetSpellInfo(351239);   --"Visage"

  SMARTBUFF_SourceOfMagic   = C_Spell.GetSpellInfo(369459);   --"Source of Magic"
  SMARTBUFF_EbonMight       = C_Spell.GetSpellInfo(395152);   --"Ebon Might"
  SMARTBUFF_BlisteringScale = C_Spell.GetSpellInfo(360827);   --"Blistering Scales"
  SMARTBUFF_Timelessness    = C_Spell.GetSpellInfo(412710);   --"Timelessness"
  SMARTBUFF_BronzeAttunement = C_Spell.GetSpellInfo(403265);  --"Bronze Attunement"
  SMARTBUFF_BlackAttunement = C_Spell.GetSpellInfo(403264);   --"Black Attunement"
  ...
  -- Tracking
  SMARTBUFF_FINDMINERALS    = C_Spell.GetSpellInfo(2580);  --"Find Minerals"
  SMARTBUFF_FINDHERBS       = C_Spell.GetSpellInfo(2383);  --"Find Herbs"
  SMARTBUFF_FINDTREASURE    = C_Spell.GetSpellInfo(2481);  --"Find Treasure"
  SMARTBUFF_TRACKHUMANOIDS  = C_Spell.GetSpellInfo(19883); --"Track Humanoids"
  SMARTBUFF_TRACKBEASTS     = C_Spell.GetSpellInfo(1494);  --"Track Beasts"
  SMARTBUFF_TRACKUNDEAD     = C_Spell.GetSpellInfo(19884); --"Track Undead"
  SMARTBUFF_TRACKHIDDEN     = C_Spell.GetSpellInfo(19885); --"Track Hidden"
  SMARTBUFF_TRACKELEMENTALS = C_Spell.GetSpellInfo(19880); --"Track Elementals"
  SMARTBUFF_TRACKDEMONS     = C_Spell.GetSpellInfo(19878); --"Track Demons"
  SMARTBUFF_TRACKGIANTS     = C_Spell.GetSpellInfo(19882); --"Track Giants"
  SMARTBUFF_TRACKDRAGONKIN  = C_Spell.GetSpellInfo(19879); --"Track Dragonkin"

  -- Racial
  SMARTBUFF_STONEFORM       = C_Spell.GetSpellInfo(20594); --"Stoneform"
  SMARTBUFF_BLOODFURY       = C_Spell.GetSpellInfo(20572); --"Blood Fury" 33697, 33702
  SMARTBUFF_BERSERKING      = C_Spell.GetSpellInfo(26297); --"Berserking"
  SMARTBUFF_WOTFORSAKEN     = C_Spell.GetSpellInfo(7744);  --"Will of the Forsaken"
  SMARTBUFF_WarStomp        = C_Spell.GetSpellInfo(20549); --"War Stomp"
  ...
  SMARTBUFF_FISHING         = C_Spell.GetSpellInfo(7620) or C_Spell.GetSpellInfo(111541); --"Fishing"
  ...
  S.LinkStats = { SMARTBUFF_BOK, SMARTBUFF_MOTW, SMARTBUFF_LOTE, SMARTBUFF_LOTWT,
                  C_Spell.GetSpellInfo(159988), -- Bark of the Wild
                  C_Spell.GetSpellInfo(203538), -- Greater Blessing of Kings
                  C_Spell.GetSpellInfo(90363),  -- Embrace of the Shale Spider
                  C_Spell.GetSpellInfo(160077)  -- Strength of the Earth
                };

  S.LinkSta   = { SMARTBUFF_PWF, SMARTBUFF_COMMANDINGSHOUT, SMARTBUFF_BLOODPACT,
                  C_Spell.GetSpellInfo(50256),  -- Invigorating Roar
                  C_Spell.GetSpellInfo(90364),  -- Qiraji Fortitude
                  C_Spell.GetSpellInfo(160014), -- Sturdiness
                  C_Spell.GetSpellInfo(160003)  -- Savage Vigor
                };
  ...
  S.LinkMa    = { SMARTBUFF_BOM, SMARTBUFF_DRUID_MKAURA, SMARTBUFF_GRACEOFAIR, SMARTBUFF_POTGRAVE,
                  C_Spell.GetSpellInfo(93435),  -- Roar of Courage
                  C_Spell.GetSpellInfo(160039), -- Keen Senses
                  C_Spell.GetSpellInfo(128997), -- Spirit Beast Blessing
                  C_Spell.GetSpellInfo(160073)  -- Plainswalking
                };
